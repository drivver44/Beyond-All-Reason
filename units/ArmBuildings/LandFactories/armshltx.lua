return {
	armshltx = {
		...
		collisionvolumescales = "144 75 144",
		...
		terraformspeed = 3000,
		workertime = 600,
		yardmap = "ooooooooo ooooooooo ooooooooo ooooooooo ooooooooo ccccccccc ccccccccc ccccccccc ccccccccc",
		buildoptions = {
			[1] = "armbanth",
			[2] = "armraz",
			[3] = "armmar",
		...
		featuredefs = {
			armshlt_dead = {
				...
				collisionvolumescales = "144 30 144",
				collisionvolumetype = "Box",
				damage = 8640,
				energy = 0,
				...
				footprintx = 9,
				footprintz = 9,
				yardmap = "ooooooooo ooooooooo ooooooooo ooooooooo ooooooooo yyyyyyyyy yyyyyyyyy yyyyyyyyy",
				height = 20,
				hitdensity = 100,
				metal = 4807,
